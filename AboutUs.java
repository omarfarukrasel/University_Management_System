...
public class AboutUs extends JFrame{
	...
	private final JPanel contentPane;
        ...
        public AboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : Omar Faruk, Lamia & Mim");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("ID Number - 1242,3003,3008");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact:faruk35-1242@diu.edu.bd,lamia35-3008@diu.edu.bd,");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("farjana35-3003@diu.edu.bd,Education - B.sc in Software Engineering");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone - +8801777625475");
