...
class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id4= new JLabel("Birthday (dd/mm/yyyy)");  
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"B.Sc","BBA","BCA","Bsc","Msc","MBA","MCA","BA","BCom"};
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"Computer Science","Software Engineering","Electronics","Electrical","Mechanical","Civil"};
